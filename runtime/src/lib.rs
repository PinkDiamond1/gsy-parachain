...
pub use pallet_contracts::weights::WeightInfo;
...
use xcm_builder::{
	...
	ParentIsDefault, RelayChainAsNative, SiblingParachainAsNative,
...
parameter_types! {
	...
	// TODO - why does not compile? Figure out the type mismatch.
	pub DeletionWeightLimit: Weight = 1000_000_000;
